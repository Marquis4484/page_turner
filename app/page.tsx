...
function Home() {
  return (
    ...
    >
      <div className="h-[98vh] w-[80vw] bg-[#2981b463] flex items-center justify-center">
        <button
          id="darkmode_button"
        ...
        <div className="flex flex-col">
          <div className="flex flex-col items-center">
            <div className="w-[352px] h-[71px] flex items-center justify-center bg-primary rounded-[20px] border-4 border-black drop-shadow-lg  mb-12 shadow-[5px_10px_8px_#4f4f4f]">
              Comic Title
            </div>
            <Link href="/comic">
